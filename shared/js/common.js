...
hr.indexOf("nore=1") <= 0 &&
  0 < hr.indexOf("a.aidn") &&
  (location.href = hr.split("a.aidn").join("aidn")),
  0 < hr.indexOf("www.aidn") &&
    (location.href = hr.split("www.aidn").join("aidn")),
  0 < hr.indexOf("daniwell.com") &&
    (location.href = "https://aidn.jp" + hr.split("daniwell.com")[1]),
...
(aidn.init = {
    ...
    addMouseWheel: function (e, t) {
      var n =
        "onwheel" in document
          ...
          : "DOMMouseScroll";
      (e =
        "string" == typeof e ? document.getElementById(e) : e).addEventListener(
        n,
        t
      );
    },
  ...
  (aidn.util = {
    ...
    getiOSVersion: function () {
      ...
      return (t && t[1]) || ((t = e.match(/iPad; CPU OS (\d+_*\d*)/)) && t[1])
    ...
    getTime: function () {
      return (
        "undefined" == typeof performance || void 0 === performance.now
          ? Date
          : performance
      ).now();
    },
    ...
    getCookie: function (e) {
      ...
      return (
        0 <= i &&
          (-1 == (e = n.indexOf(";", (i = i + e.length))) && (e = n.length),
    ...
    setStorage: function (e, t) {
      void 0 === t && (t = location.href.split("/")[3]),
        null == (e = "object" == typeof e ? JSON.stringify(e) : e)
    ...
    needExpandArea: function (e) {
      ...
      return (
        (t =
          (0 <= t.indexOf("iPhone") || 0 <= t.indexOf("iPod")) &&
          0 <= t.indexOf("Version/") &&
    ...
    selectAndCopyText: function (e) {
      var e = document.getElementById(e),
        ...
        n = (t.selectNodeContents(e), window.getSelection());
      n.removeAllRanges(),
        n.addRange(t),
    ...
    enabledNavigatorFileShare: function () {
      return (
        ...
        (!aidn.util.checkiOS() || 15 <= aidn.util.getiOSVersion())
      );
    },
    navigatorFileShare: function (e) {
      var t = (t = e.file) || new File([e.blob], e.name, { type: e.type });
      navigator
        .share({ text: e.text, files: [t] })
        .then(e.success)
        .catch(e.fail);
    },
    changeUrl: function (e, t = !0) {
      var n,
        i = location.href.split("?")[0].split("#")[0];
      2 ==
        (n = (i =
          0 < i.indexOf("html")
            ? ((n = i.split("html")).pop(), n.join("html") + "html")
            : ((n = i.split("/")).pop(), n.join("/") + "/")).split(/\/\/.+?\//))
          .length && (i = "/" + n[1]),
        (i += e),
      ...
      aidn.util.checkStandAlone() &&
        $("a").each(function (e, t) {
          var n = $(this),
            i = n.attr("target"),
            a = !0,
            o = (i && 0 <= i.indexOf("blank") && (a = !1), n.attr("href"));
          a &&
            o &&
            "" != o &&
            (n.click(function (e) {
  ...
  (aidn.window = {
    ...
    addDummyDiv: function () {
      var e;
      aidn.window.useDummyDiv() &&
        ((e = $("<div id='dummy'></div>")).css({
          width: "100%",
          height: "100%",
          position: "fixed",
          zIndex: -1,
    ...
    height: function () {
      return aidn.window._isTwitteriOS
        ? window.innerHeight
        : (aidn.window._dummy || $(window)).height();
    },
    addVisibilityChangeEvent: function (e) {
      ...
      void 0 !== document.hidden
        ...
        void 0 !== document.addEventListener &&
          ...
          document.addEventListener(
            n,
            aidn.window._visibilityChangeHandler,
            !1
          );
    },
    ...
    scrollOff: function () {
      0 < navigator.userAgent.indexOf("SamsungBrowser") ||
    ...
    _resize: function () {
      if (
        (aidn.window._isTwitteriOS &&
          aidn.window._isFit &&
          aidn.util.getiOSVersion() < 14 &&
          $("body").height(window.innerHeight + 20),
        aidn.window._isTwitteriOS)
      )
        for (var e = 0; e < 8; e++)
          setTimeout(aidn.window._resizeFix, 100 * (e + 1));
      else aidn.window._resizeFix();
    },
    _resizeFix: function () {
      var e;
      aidn.window._isTwitteriOS &&
        aidn.window._isFit &&
        ((e = Math.max(window.innerHeight, $(window).height())),
        $("body").height(e)),
  ...
  (aidn.math = {
    ...
    from10: function (
      ...
      var n = t.length,
        i = "",
        a = !1;
      if (0 == (e = parseInt(e))) return t.charAt(0);
      for (e < 0 && ((a = !0), (e = Math.abs(e))); e; )
        (i = t[Math.floor(aidn.math.fmod(e, n))] + i), (e = Math.floor(e / n));
      return (i = a ? "-" + i : i);
    },
    to10: function (
      e,
  ...
  (aidn.string = {
    breakStr: function (e, t, n) {
      void 0 === n && (n = !0), 0 < t || (t = 1);
      for (
        var i = this.toArraySurrogate(e),
          a = Math.ceil(i.length / t),
          o = [],
          r = !0,
          d = 0,
          l = i.length;
      ...
      for (; 0 < i.length; ) o.push(i.splice(0, a));
      for (var c, d = 0, l = o.length; d < l; d++)
        if (
          (d < l - 1 &&
            ((c = o[d][o[d].length - 1]), 0 <= "[{(<「『【（［".indexOf(c)) &&
            o[d + 1].unshift(o[d].pop()),
          1 <= d &&
            ((c = o[d][0]), 0 <= ',.!?]})>"、。」』】）］！？'.indexOf(c)) &&
            o[d - 1].push(o[d].shift()),
          d < l - 1 && r)
        ) {
          ...
          if (0 < u && u < 5)
            for (var f = 0; f < u; f++)
              s
                ? ((h = o[d][o[d].length - u - 1]),
                  o[d + 1].unshift(o[d].pop()))
                : ((h = o[d + 1][u]), o[d].push(o[d + 1].shift()));
        }
      if (!n) return o;
      for (var p = [], d = 0, l = o.length; d < l; d++) p[d] = o[d].join("");
      return p;
    },
    toArraySurrogate: function (e) {
      try {
        for (
          var t = Array.from(
              new Intl.Segmenter("ja", { granularity: "grapheme" }).segment(e)
            ),
            n = [],
            i = 0;
          i < t.length;
    ...
    checkEnglish: function (e) {
      for (var t = this.toArraySurrogate(e), n = 0, i = t.length; n < i; n++) {
        var a = t[n];
        if (1 == a.length && 256 <= a.charCodeAt(0)) return !1;
      }
      return !0;
    },
  ...
  (aidn.color = {
      ...
      var t,
        ...
        o =
          o <= 1
            ? ((n = (a / 60) * ((t = i) - e) + e), e)
            : o <= 2
            ? ((t = ((120 - a) / 60) * (i - e) + e), (n = i), e)
            : o <= 3
            ? ((a - 120) / 60) * ((n = i) - (t = e)) + e
            : o <= 4
            ? ((n = ((240 - a) / 60) * (i - (t = e)) + e), i)
            : o <= 5
            ? ((t = ((a - 240) / 60) * (i - e) + e), (n = e), i)
            : ((360 - a) / 60) * ((t = i) - (n = e)) + e;
    ...
    hsvToRgb: function (e) {
      var t,
        ...
        i = e[1],
        a = e[2];
      if (0 == i) return [255 * a, 255 * a, 255 * a];
      var e = parseInt(n),
        n = n - e,
        o = a * (1 - i),
        r = a * (1 - i * n),
...
function __addRelease(e, t, n, i, a, o, r, d) {
  if (
    "string" != typeof (d = void 0 === d ? null : d) ||
    ((d = "_release" + d), "1" != aidn.util.getCookie(d))
  ) {
    "string" != typeof a && (a = "NEW RELEASE"),
      "string" != typeof o && (o = "NEW RELEASE"),
      _isJapanese || (a = o);
    for (
      var l = "Noto+Sans+JP:wght@500",
        c = !1,
        s = "Poppins:wght@500",
        u = !1,
        h = $("link"),
      ...
      g && (0 < g.indexOf(l) && (c = !0), 0 < g.indexOf(s)) && (u = !0);
    }
    (c && u) ||
      ((o = '<link href="https://fonts.googleapis.com/css2?family='),
      c || (o += l),
      c || u || (o += "&family="),
      u || (o += s),
    ...
    var m = Date.now() + Math.floor(1e5 * Math.random()),
      o = "calc(0.6rem + 0.6vh)",
      i = (24 <= n.length && (o = "calc(0.55rem + 0.5vh)"), "bottom"),
      r =
        "white-space: nowrap; position: fixed; " +
        (i = 1 == r ? "top" : i) +
        ": -2px; z-index: 100000; left: 50%; transform: translateX(-50%); width:100%; max-width: 480px; color: #fff; background:#555560a0; text-align:left; cursor:pointer; letter-spacing: .4rem; line-height: 1; border: solid 1px rgba(255, 255, 255, 0.2); transition: all .12s;",
      i =
        '<div id="rel_open' +
        m +
        '" style="' +
        (r += "font-family:Poppins,'Noto Sans JP',sans-serif;") +
        '">',
      i =
        (i =
          (i =
            (i =
              (i +=
                '<img src="' +
                e +
                '" style="width:calc(45px + 2.4vh); height:calc(45px + 2.4vh); margin: calc(4px + 1.0vh); margin-right: calc(6px + 1.2vh); vertical-align:middle;">') +
              '<p style="display:inline-block; vertical-align:middle; letter-spacing:.15rem; line-height:1.6; font-weight:500; margin-bottom:10px;">' +
              ('<span style="font-size:calc(0.4rem + 0.7vh); color: #f9a;" class="blink">' +
                a +
                "</span><br>")) +
            ('<span style="font-size:' +
              o +
              '; border-bottom: calc(1px + 0.15vmin) solid; padding-bottom: 4px;">' +
              n +
              "</span>") +
            "</p>") +
          ('<p id="rel_close' +
            m +
            '" style="position:absolute; right:0; top:0; padding:1vh;">') +
          '<svg style="width: calc(24px + 2vmin); transition: fill .12s;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path fill="#fff" d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>') +
        "</p>" +
        "</div>";
    $("body").append(i),
      (i =
        (i =
          ...
          ("#rel_open" +
            m +
            ":hover { background: #333339cc !important; } \n")) +
...
function __checkInit() {
  ...
  "undefined" == typeof jQuery
    ...
    : ((e = window.__s) &&
        "string" == typeof e &&
        ($.ajax({ url: e, cache: !0, dataType: "script" }), delete window.__s),
      $(function () {
        ...
        8 <= e &&
          ...
          document.addEventListener("visibilitychange", function (e) {
            "visible" == document.visibilityState &&
              location.href != localStorage.getItem(E) &&
              (location.href = localStorage.getItem(E));
          }));
        for (
          var t = document.querySelectorAll(".lazy_css"), n = 0, d = t.length;
          n < d;
          n++
        )
          t[n].rel = "stylesheet";
        ...
        function s(e) {
          "hidden" == $("html, body").css("overflow") &&
            ($("html, body").css("overflow", "hidden auto"), 15.5 <= e) &&
        ...
        if (
          ((0 < l.indexOf("MSIE") || 0 < l.indexOf("rv:11.0")) &&
            0 < $("svg").length &&
            ((i = -1),
            $(window).resize(function () {
              clearTimeout(i), (i = setTimeout(c, 200));
            }),
            c(),
            setInterval(c, 1e3)),
          0 <= location.href.indexOf("?lc=ja") &&
            setTimeout(function () {
          ...
          for (
            ...
            0 < f.indexOf(h[n]) && ((p = !0), (d = h[n].split("/").length - 2));
          1 == $("body").data("motion") &&
            2 <= (l = location.href.split("aidn")).length &&
            ((p = !0), (d = l[1].split("/").length - 3)),
            p &&
              ((u = setTimeout(function () {
                var e = "",
                  t =
                    ((e +=
                      '<div style="width:100%; height:100%; background:rgba(255, 255, 255, 0.975); position:fixed; z-index:1000000; top: 0; left: 0; display: none;">'),
                    ""),
                  n =
                    "../shared/img/dialog_sensor" +
                    (t = 13 <= aidn.util.getiOSVersion() ? "_13" : t) +
                    ".png";
                _isJapanese ||
                  (n = "../shared/img/dialog_sensor_en" + t + ".png");
                for (var i = 0; i < d; i++) n = "../" + n;
                var e =
                    e +
                    ('<img src="' +
                      n +
        ...
        0 < location.href.indexOf("/wow") &&
          ((m = `<p style="font-family: 'Sawarabi Gothic', sans-serif; font-size: calc(0.5rem + 0.6vmin); animation: none; margin-top: calc(15px + 1.5vmin);">[tx]</p>`),
          (m = _isJapanese
            ? m.replace("[tx]", "サウンドをオンにしてお楽しみください。")
            : m.replace("[tx]", "Please enjoy this content with sound on.")),
          $("#top").append(m));
        for (
          var m,
            v = !1,
            ...
            y = "NOW ON SALE",
            b = "nyancat10th/",
            x = "daniwell/shared/img/jacket/nyancat_arrangements.png",
            _ = "Nyan Cat Arrangements",
            k = "Nyan Cat Arrangements",
            h = [
              { path: "/nyancat/" },
              { path: "/momotap" },
              { path: "/mikutap" },
          ...
          if (0 < f.indexOf(O.path)) {
            (p = !0),
              (E = "_sub"),
              O.key && (E = O.key),
              O.desc && ((w = O.desc), (y = O.desc)),
              O.descEn && (y = O.descEn),
              O.link && (b = O.link),
              O.imgPath && (x = O.imgPath),
              O.title && ((_ = O.title), (k = O.title)),
        ...
        if (0 < $("#aidnx").length || p) {
          for (
            var S = (f = (
                0 <=
                (f = location.href.split("#")[0].split("?")[0]).indexOf(
                  "aidn.jp/"
                )
                  ? f.split("aidn.jp/")
                  : f.split("aidn/")
              )[1]).split("/").length,
              A = (0 < $("#aidnx").length && (E = "_aidnx"), ""),
              n = 0;
            n < S - 1;
            n++
          )
            A += "../";
          x.indexOf("http") < 0 && (x = A + x),
            b.indexOf("http") < 0 && (b = A + b),
            "" != A && __addRelease(x, b, _, k, w, y, v, E);
        }
        0 < $("#aidn").length && (_active = !1),
          ...
          _active ||
            ((e = aidn.constant.advUrlEn),
            (m =
              (m =
                (m = "") +
                '<a href="' +
                (e = aidn.util.checkJapanese() ? aidn.constant.advUrlJa : e) +
              ...
              '" /></p></div></a>'),
            0 < (l = $("#common_back")).length &&
              ((m =
                '<div class="adv"><div class="hr_top"></div>' + m + "</div>"),
              $("body").css("overflow", "auto"),
              l.after(m),
              "undefined" != typeof swfobject) &&
              ((e = "before"),
              1 != (l = $("p.img")).length && ((l = $("h1")), (e = "after")),
              l[e](
                '<p style="margin: 30px 0;">&gt; <a href="?ruffle=1">JavaScriptで実行する</a><br>(正しく動作しない場合があります)</p>'
              )));
      }));
}
(_active =
  ...
  (aidn.Audio = function () {
    ...
    (this._audio = u).addEventListener("playing", function () {
      ...
      u.addEventListener("timeupdate", function () {
        ...
        0 <= h && h != u.currentTime && c && (c(), (c = null));
        h = u.currentTime;
      }),
      ...
      (this.load = function (t, n, i, a) {
        isNaN(i) || (i = null), a && (i = a), "string" == typeof t && (t = [t]);
      ...
      (this.play = function (t, e, n, i, a) {
        ...
        if ((u.play(), 0 < i && "undefined" != typeof jQuery)) {
          s.volume = 0;
          try {
            $(s)
              .stop()
              .animate({ volume: a }, 1e3 * i, "easeInSine");
          } catch (e) {
            $(s)
              .stop()
              .animate({ volume: a }, 1e3 * i, "linear");
          }
        } else s.volume = a;
      }),
      (this.pause = function () {
  ...
  (aidn.WebAudio = function () {
    ...
    (this.load = function (e, u, t, n) {
      ...
      if (
        (0 < e[0].indexOf("blank.mp3") &&
          ((t = new Audio(e[0])), document.body.appendChild(t)),
        !I)
      )
        return !1;
      I.createBufferSource().start(0), (h = null);
      var l,
        t = aidn.audio.getPath(e);
      return !(
        (!t && !i) ||
        (i
          ? c()
          : ((l = new XMLHttpRequest()).open("GET", t, !0),
      ...
      function c() {
        ...
        I.decodeAudioData(
          ...
          function (e) {
            if (0 <= T) {
              for (
                var t = T, n = Number.MAX_VALUE, i = e.numberOfChannels, a = 0;
                a < i;
                a++
              ) {
                for (
              ...
              for (
                var r = e.length - n,
                  l = I.createBuffer(i, r, I.sampleRate),
                  a = 0;
                a < i;
                a++
              )
                for (
                  var c = e.getChannelData(a), s = l.getChannelData(a), d = 0;
                  d < r;
                  d++
                )
                  s[d] = c[d + n];
      ...
      (this.play = function (e, t, n, i, a, o, r) {
        if (((v = e), (w = t), (y = n), (b = i), (x = a), (_ = o), h)) {
          ...
          var d,
            l = [f, g];
          p && l.push(p), m && l.push(m);
          for (var c = 1; c < l.length; c++) (u = l[c - 1]).connect((d = l[c]));
          ...
          if (
            (f.start ? f.start(I.currentTime + o, e) : f.noteOn(e),
            (S = I.currentTime - e),
            (this._source = f),
            (this.nodeGain = g),
          ...
          n &&
            (s = setInterval(function () {
              0 < k.time && (clearInterval(s), n());
            }, 10));
        } else (F = !0), console.log('call "load" method before "play"');
      }),
      (this.stop = function (e) {
        if ((void 0 === e && (e = 0), (F = !1), f))
          try {
      ...
      (this.initPanner = function (e) {
        return (
          0 < (e = void 0 === e || e <= 0 ? "equalpower" : e) && (e = "HRTF"),
      ...
      (this.initBiquadFilter = function (e) {
        return (
          void 0 === e && (e = 0), ((m = I.createBiquadFilter()).type = e), m
        );
      }),
      (this.addNode = function (e, t) {
        return E.push(e), O.push(t), E.length - 1;
      }),
      (this.removeNode = function (e) {
        var t;
        return e < 0 || E.length <= e
          ? null
          : ((t = E.splice(e, 1)[0]), O.splice(e, 1), t);
      }),
      (this.addEndEvent = function (e) {
        t = e;
      }),
  ...
  (aidn.AutoAudio = function (e, t, n) {
    ...
    null != e
      ...
      0 == (d = 0 <= n && n <= 2 ? n : d)
        ...
        : ((i = new (1 == d ? aidn.WebAudio : aidn.Audio)()),
          (this.audio = i),
          t &&
            setTimeout(function () {
              t(d);
  ...
  (aidn.SceneManager = function () {
    ...
    (this.init = function (e, t = 150) {
      ...
      (this.show = function (e, t = !0) {
        0 <= n &&
          (l(d[n]), clearTimeout(i), t) &&
          (i = setTimeout(l, 2 * r, d[n])),
          0 <= e &&
            (o(d[e]), clearTimeout(a), t) &&
            (a = setTimeout(o, 2 * r, d[e])),
          (n = e);
      });
  }),
